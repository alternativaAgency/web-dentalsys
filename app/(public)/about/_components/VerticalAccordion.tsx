...
const VerticalAccordion = () => {
  ...
  return (
    <section className="p-4 border-0 shadow-dodgerblue-300">
  ...
  return (
    <>
      ...
      >
        ...
        <div className="w-6 lg:w-full aspect-square bg-dodgerblue-600 text-white grid place-items-center">
          <Icon />
        </div>
